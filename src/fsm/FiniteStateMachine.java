...
public class FiniteStateMachine implements StateMachine {
    ...
    private final Map<State, State> resetTable = new HashMap<>();
    ...
    public void addReset(State state, State resetState) {
        resetTable.put(state, resetState);
    }
    ...
    @Override
    public void reset() {
        current = resetTable.get(current);
    }
